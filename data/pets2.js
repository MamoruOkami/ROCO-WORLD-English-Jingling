const petList2 = [
    {id:11,name:"鸭吉吉",element:"普通",
        ...
        skills:[{name:"猛烈撞击", element:"普通", type:"物攻", cost:1, power:60,
            ...
            desc:"造成魔伤，自己回复1能量。"},
            {name:"防御", element:"普通", type:"防御", cost:0, power:0,
            desc:"减伤70%，应对攻击。"},
            ...
            desc:"减伤60%，应对攻击：敌方脱离。"},
            {name:"见招拆招", element:"普通", type:"物攻", cost:2, power:0,
    ...
    {id:12,name:"板板壳",element:"水",
        ...
        skills:[{name:"防御", element:"普通", type:"防御", cost:1, power:0,
            ...
            {name:"后发制人", element:"普通", type:"物攻", cost:3, power:140,
            desc:"造成物理伤害，先手-1。"},
    ...
    {id:15,name:"锥尾羊",element:"幽",
        ...
        skills:[{name:"力量增效", element:"普通", type:"状态", cost:1, power:0,
            desc:"自己获得物攻+100%。"},
            {name:"恶能量", element:"恶", type:"物攻", cost:1, power:60,
            desc:"对敌方精灵造成物理伤害。"},
            {name:"幻象", element:"幽", type:"物攻", cost:1, power:60,
            desc:"对敌方精灵造成物理伤害。"},
            {name:"勾魂", element:"幽", type:"状态", cost:1, power:0,
            desc:"偷取敌方3能量。"},
            {name:"虚假破产", element:"恶", type:"防御", cost:2, power:0,
            ...
            desc:"造成物伤，若上回合使用状态技能，本次技能威力+55。"},
            {name:"恶作剧", element:"幽", type:"状态", cost:0, power:0,
            desc:"敌方失去3能量，应对防御：改为敌方失去6能量。"},
            {name:"极限撕裂", element:"恶", type:"物攻", cost:4, power:140,
    ...
    {id:18,name:"雪绒鸟",element:"翼",
        ...
        skills:[{name:"力量增效", element:"普通", type:"状态", cost:0, power:0,
            ...
            {name:"快速移动", element:"普通", type:"状态", cost:1, power:0,
            desc:"自己获得速度+80，应对防御：改为速度+160。"},
            {name:"羽刃", element:"翼", type:"物攻", cost:2, power:70,
